...
if (isset($_POST['submit'])) {
	...
	$ret = mysqli_query($con, "SELECT * FROM users WHERE email='$uname' and password='$pwd'");
	...
	<div class="row">
		<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			...
			<div class="box-login">
				...
				<div class="copyright">
					</span><span class="text-bold text-uppercase">© 2024 CareMed. All rights reserved</span>.
				</div>
